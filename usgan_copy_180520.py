...
#data = "/floyd/input/"
data = "/floyd/input"
#data = "yadunandankini/datasets/ultrasound/1"
...
class Generator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose2d( gen_input_size,
                               ngf * 8,
                               4,# kernel size
                               1,# stride
                               0,# padding
            ...
            nn.ConvTranspose2d( channels, ngf, 4, 2, 1, bias=False),
            nn.Tanh()
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        print("size of label: {}".format(label.size(0)))
        # Forward pass real batch through D
        output = netD(real_cpu).view(-1)
        print("size of output: {}".format(output.size(0)))
